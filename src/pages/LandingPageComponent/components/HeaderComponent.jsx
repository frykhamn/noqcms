...
import {
  fetchNightTemperature,
  homelessAmount,
} from "../../CMSComponents/customHooks/nightTemp";
      ...
      <div className="text-white p-4">
        ...
        <div>
          <h4 className="text-xl md:text-2xl lg:text-3xl mb-8">
            ...
            {nightTemperature}°C i natt.
          </h4>
        </div>

        <div className="flex flex-col md:flex-row gap-4">
{/*           <Link to={"/partner"}>
            <BigButton variant={"primary"} title={"Bli Partner"}></BigButton>
          </Link>
          <a
